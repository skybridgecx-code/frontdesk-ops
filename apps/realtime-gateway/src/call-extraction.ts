import { getOpenAIClient } from './openai-realtime.js';
        ...
        content: [
          {
            type: 'input_text',
            text:
              'Extract structured lead data from a phone call. Return only fields that are directly supported by the transcript. Do not guess. If a field is missing or unclear, return null.'
          }
        ]
      },
      {
